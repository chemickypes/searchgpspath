...
//    	GPXParser gpxp = new GPXParser("/home/angelo/Documenti/prova.gpx");
//		gpxp.parse();
//		
//		ArrayList<TrackSegment> tracks = (ArrayList<TrackSegment>) gpxp.getTracks();
//		ArrayList<Point> track = new ArrayList<>();
//		
//		for(TrackPoint tp:tracks.get(0).getPoints()){
//			//the point have geographic coordinates to use you must change them
//			track.add(new Point(tp.getLatitude(), tp.getLongitude(), "n_tr"));
//		}
//		
//		for(Point p:track){
