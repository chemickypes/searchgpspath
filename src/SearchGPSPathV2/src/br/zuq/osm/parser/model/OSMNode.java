...
public class OSMNode extends AbstractNode {
    ...
    public float distance(OSMNode n){
    	float distance = (float) LatLongUtil.distance(Double.valueOf(this.lat),Double.valueOf( this.lon),
				Double.valueOf(n.lat),Double.valueOf( n.lon));
    	return distance;
    }
}
